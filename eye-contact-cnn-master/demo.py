...
# gaze locking CAVAE:https://cave.cs.columbia.edu/projects/categories/project?cid=Visual+Recognition&pid=Gaze+Locking+Passive+Eye+Contact+Detection+for+Human+Object+Interaction
# eye contact detection using deep neural networks: https://github.com/rehg-lab/eye-contact-cnn 
